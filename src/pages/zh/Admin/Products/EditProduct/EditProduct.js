...
import { updateZhProduct, getZhProductById } from '~/services/productService';
...
const EditProduct = () => {
    ...
    useEffect(() => {
        ...
        const fetchProduct = async () => {
            try {
                const productData = await getZhProductById(id);
    ...
    const handleSubmit = async (values, { resetForm }) => {
        ...
        formData.append('zh_child_nav_id', values.updateCate);
        ...
        try {
            await updateZhProduct(id, formData);
            ...
            {product && (
                <Formik
                    initialValues={{
                        ...
                        updateCate: product.zh_child_nav_id || '',
