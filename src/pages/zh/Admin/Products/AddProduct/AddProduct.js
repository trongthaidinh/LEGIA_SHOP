...
import { createZhProduct } from '~/services/productService';
...
const AddProduct = () => {
    ...
    const validationSchema = Yup.object({
        ...
        zh_child_nav_id: Yup.string().required('Danh mục là bắt buộc'),
    ...
    useEffect(() => {
        const fetchCategories = async () => {
            try {
                const fetchedCategories = await getZhCategoriesBySlug('产品');
    ...
    const handleSubmit = async (values, { resetForm }) => {
        ...
        formData.append('zh_child_nav_id', values.zh_child_nav_id);
        formData.append('features', JSON.stringify(features));
        formData.append('phone_number', values.phone_number);

        try {
            await createZhProduct(formData);
            ...
            <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={handleSubmit}>
                {({ isSubmitting, setFieldValue, values }) => (
                    <Form className={styles.form}>
                        ...
                        <div className={styles.formGroup}>
                            <label htmlFor="zh_child_nav_id">Danh Mục</label>
                            <Field as="select" name="zh_child_nav_id" className={styles.input}>
                            ...
                            <ErrorMessage name="zh_child_nav_id" component="div" className={styles.error} />
                        </div>
                        <div className={styles.formGroup}>
                        ...
                        <div className={styles.buttonGroup}>
                            ...
                            <Button secondary type="button" onClick={() => navigate(routes.productListZH)}>
                                Hủy
                            </Button>
                        </div>
                    </Form>
