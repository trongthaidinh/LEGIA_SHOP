...
import { deleteZhReview, getZhReviews } from '~/services/reviewService';
    ...
    return (
        <div className={styles.reviewContainer}>
            ...
            <div className={styles.actionsContainer}>
                ...
                />
                <Link to="/zh/admin/add-review" className={styles.addButton}>
                        ...
                        {filteredReviews.length > 0 ? (
                            filteredReviews.map((review) => (
                                <tr key={review.id}>
                                    ...
                                    <td>{review.review}</td>
                                    <td>
                                        <Link to={`/zh/admin/update-review/${review.id}`} className={styles.editButton}>
