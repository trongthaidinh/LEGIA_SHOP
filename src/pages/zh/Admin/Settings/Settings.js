...
import { getZhConfiguration, updateZhConfiguration, getZhConfigurationMobile } from '~/services/configurationService';
...
const Settings = () => {
    ...
    useEffect(() => {
        const fetchSettings = async () => {
            try {
                const data =
                    configurationType === 'desktop' ? await getZhConfiguration() : await getZhConfigurationMobile();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Add homepage_slider URLs as JSON string
            ...
            await updateZhConfiguration(formData, settings.id);
