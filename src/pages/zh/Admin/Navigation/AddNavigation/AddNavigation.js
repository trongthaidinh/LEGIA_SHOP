...
import {
    getZhSubNavigation,
    getZhMainNavigation,
    createZhMainNavigationLink,
    createZhSubNavigationLink,
    createZhChildNavigationLink,
...
const AddNavigation = () => {
    ...
    useEffect(() => {
        const fetchNavigations = async () => {
            const data = await getZhSubNavigation();
            setNavigations(data);
        };
    ...
    return (
        <div className={styles.navigationContainer}>
            <div className={styles.formContainer}>
                <Title className={styles.pageTitle} subText="Thêm mới Navigation" />
                                    ...
                                    onChange={(e) => {
                                        ...
                                        if (value === 'main') {
                                            ...
                                            const fetchMainNavigations = async () => {
                                                const data = await getZhMainNavigation();
                                                setNavigations(data);
                                            };
